        ...
        saxStream.on('opentag', (tag) => {
            ...
            try {
                ...
                if ('svg' === tag.name) {
                    ...
                    glyph.paths?.push(applyTransform(SVGShapes.createRect(tag.attributes.x ? parseFloat(tag.attributes.x) : 0, tag.attributes.y ? parseFloat(tag.attributes.y) : 0, tag.attributes.width
                        ? parseFloat(tag.attributes.width)
                        : 0, tag.attributes.height
                        ? parseFloat(tag.attributes.height)
                        : 0, tag.attributes.rx
                        ? parseFloat(tag.attributes.rx)
                        : tag.attributes.ry
                            ? parseFloat(tag.attributes.ry)
                            : 0, tag.attributes.ry
                        ? parseFloat(tag.attributes.ry)
                        : tag.attributes.rx
                            ? parseFloat(tag.attributes.rx)
                    ...
                    glyph.paths?.push(applyTransform(SVGShapes.createPolyline([
                        tag.attributes.x1 ? parseFloat(tag.attributes.x1) : 0,
                        tag.attributes.y1 ? parseFloat(tag.attributes.y1) : 0,
                        tag.attributes.x2 ? parseFloat(tag.attributes.x2) : 0,
                        tag.attributes.y2 ? parseFloat(tag.attributes.y2) : 0,
                    ]).encode()));
                }
                    ...
                    glyph.paths?.push(applyTransform(SVGShapes.createPolyline((tag.attributes.points || '')
                        .split(/\s/gm)
                        .map((coord) => coord.split(',').map((n) => parseFloat(n)))
                        .flat()).encode()));
                }
                else if ('polygon' === tag.name && 'none' !== tag.attributes.fill) {
                    glyph.paths?.push(applyTransform(SVGShapes.createPolygon((tag.attributes.points || '')
                        .split(/\s/gm)
                        .map((coord) => coord.split(',').map((n) => parseFloat(n)))
                        .flat()).encode()));
                }
                    ...
                    glyph.paths?.push(applyTransform(SVGShapes.createEllipse(tag.attributes.rx
                        ? parseFloat(tag.attributes.rx)
                        : tag.attributes.r
                            ? parseFloat(tag.attributes.r)
                            : 0, tag.attributes.ry
                        ? parseFloat(tag.attributes.ry)
                        : tag.attributes.r
                            ? parseFloat(tag.attributes.r)
                            : 0, tag.attributes.cx ? parseFloat(tag.attributes.cx) : 0, tag.attributes.cy ? parseFloat(tag.attributes.cy) : 0).encode()));
                }
