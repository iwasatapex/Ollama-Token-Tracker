...
describe('Passing code points', () => {
    test('should work with multiple unicode values for a single icon', async () => {
        ...
        svgFontStream.end();
        expect((await promise).toString()).toEqual(fs.readFileSync(join('fixtures', 'expected', 'cleanicons-multi.svg'), {
            encoding: 'utf8',
        }));
    });
    test('should work with ligatures', async () => {
        ...
        svgFontStream.write(svgIconStream);
        svgFontStream.end();
        expect((await promise).toString()).toEqual(fs.readFileSync(join('fixtures', 'expected', 'cleanicons-lig.svg'), {
            encoding: 'utf8',
        }));
    });
    test('should work with high code points', async () => {
        ...
        svgFontStream.write(svgIconStream);
        svgFontStream.end();
        expect((await promise).toString()).toEqual(fs.readFileSync(join('fixtures', 'expected', 'cleanicons-high.svg'), {
            encoding: 'utf8',
        }));
    });
});
describe('Providing bad glyphs', () => {
    test('should fail when not providing glyph name', async () => {
        ...
        new SVGIcons2SVGFontStream({ round: 1e3 })
            ...
            expect(err.message).toEqual('Please provide a name for the glyph at index 0');
        })
            .write(svgIconStream);
    });
    test('should fail when not providing codepoints', async () => {
        ...
        new SVGIcons2SVGFontStream({ round: 1e3 })
            .on('error', (err) => {
            expect(err instanceof Error).toBeTruthy();
            expect(err.message).toEqual('Please provide a codepoint for the glyph "test"');
        })
            .write(svgIconStream);
    });
    test('should fail when providing unicode value with duplicates', async () => {
        ...
        new SVGIcons2SVGFontStream({ round: 1e3 })
            .on('error', (err) => {
            expect(err instanceof Error).toBeTruthy();
            expect(err.message).toEqual('Given codepoints for the glyph "test" contain duplicates.');
        })
            .write(svgIconStream);
    });
    test('should fail when providing the same codepoint twice', async () => {
        ...
        svgFontStream.on('error', (err) => {
            expect(err instanceof Error).toBeTruthy();
            expect(err.message).toEqual('The glyph "test2" codepoint seems to be used already elsewhere.');
        });
        svgFontStream.write(svgIconStream);
    ...
    test('should fail when providing bad pathdata', async () => {
        ...
        new SVGIcons2SVGFontStream({ round: 1e3 })
            .on('error', (err) => {
            expect(err instanceof Error).toBeTruthy();
            expect(err.message).toEqual('Got an error parsing the glyph "test":' +
